//Ej 17) La cajera de un supermercado ha registrado varias ventas,
//de cada una sabe:
...
//En el caso de estar en promoción, se realiza un descuento del 10%
//sobre el precio base.
//Se pide ingresar los datos e informar:
//a) Monto total de cada venta, el total del descuento y el precio
//final a pagar.
//b) Nombre del cliente que compró la mayor cantidad de artículos
//en oferta.
