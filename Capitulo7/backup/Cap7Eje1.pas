//Ej 1) El departamento de Recursos Humanos de una empresa
//desea que sus empleados fraternicen y decidió cada 3 meses
//hacer un brindis por los que nacieron en esa estación
//del año. Se pide:
// Leer los datos (Nombre del empleado y Fecha de
//Nacimiento)
// Informar en qué estación del año se festejan más
//cumpleaños
program cap7Eje1;
uses
   crt;
